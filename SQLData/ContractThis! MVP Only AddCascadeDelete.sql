...
CREATE TABLE [ProjectComponent] (
  ...
  CONSTRAINT [FK_Project_Component] FOREIGN KEY ([ProjectId]) REFERENCES [dbo].[Project] ([Id]) ON DELETE CASCADE,
...
CREATE TABLE [ProjectComponentImages] (
  ...
  CONSTRAINT [FK_Project_Component_Image] FOREIGN KEY ([ProjectComponentId]) REFERENCES [dbo].[ProjectComponent] ([Id]) ON DELETE CASCADE,
)
GO
